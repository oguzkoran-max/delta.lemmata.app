...
Machine-readable execution metadata is in
`provenance/runs/RUN-20260710-0003.json`. The development request is represented
by its native-message hash in PromptEvent `PE-20260710-0002`; the repository does
not claim to store a complete response transcript.
